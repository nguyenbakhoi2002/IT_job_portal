                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="40%" class="logo" style="text-align: left;">
                                    <h1><a href="#"><img src="{{ asset('images/logo_bakhoi.png') }}"
                                                width="40%"></a></h1>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: center;color: black;">
                                        <h2 style="color: black;">BaKhoi Xin chào!</h2>
                                        ...
                                        <button
                                            style="background-color:#C46F01;border:none;width: 150px;height: 40px;color: #fff;border-radius: 8px;"><a
                                                href="{{ route('company.getPass', ['company' => $candidate, 'token' => $candidate->token]) }}" style="color: #fff;text-decoration: none">Đặt lại mật khẩu</a></button>
