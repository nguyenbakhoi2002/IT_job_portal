        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><a href="{{route('admin.language.index')}}" class="" style="margin-right:10px"><i class="fa-solid fa-arrow-left"></i></i></a>   {{$title}}</h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions xoa text-right d-flex align-items-center">
                            <a href="{{route('admin.language.restore', $item->id)}}" class="btn btn-success">Khôi phục</a>
                            <a href="{{route('admin.language.forceDelete', $item->id)}}" onclick="return confirm('Bạn có chắn chắn muốn xóa')" class="btn btn-danger mx-3">Xóa</a>
