    ...
    <div class="container-fluid">
        <div class="">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form  method="POST" action="{{ route('admin.language.update', $major)}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="inputName">Tên ngoại ngữ <span class="text-danger">*</span></label>
                  ...
                  <div class="">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{route('admin.language.index')}}" class="btn btn-secondary">Hủy</a>
                    </div>
                  </form>
                </div>
                <!-- /.card-body -->
