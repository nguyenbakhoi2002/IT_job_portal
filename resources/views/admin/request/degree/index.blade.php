      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <a href="{{route('admin.degree.trash')}}" class="btn btn-primary mt-4 mx-4" style="width: 150px">thùng rác <i class="fa fa-trash"></i></a>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                ...
                <tr>
                  ...
                  <th>cấp độ</th>
                  <th>trạng thái</th>
                  <th><a href="{{route('admin.degree.create')}}"><i class="fa fa-plus"></i></a></th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions xoa text-right d-flex align-items-center">
                            <a class="btn btn-info mr-3" href="{{route('admin.degree.edit', $item)}}">
                              <i class="fa fa-edit"></i>
                            </a>

                            <form action="{{route('admin.degree.destroy', $item)}}" method="POST">
                                @csrf
                                @method("DELETE")
