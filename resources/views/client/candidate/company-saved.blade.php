            ...
            <div class="ls-widget">
              <div class="tabs-box">
                <div class="widget-title">
                  <h3 style="margin: auto">Danh sách {{count($saved_jobs)}} công ty đã lưu</h3>
                        ...
                        <tr>
                            ...
                            <div class="job-block">
                              <div class="inner-box">
                                <div class="content d-flex">
                                  <span class="company-logo" style="width:100px; height: 50px"><img style="width:100px; height: 50px" src="{{asset('/uploads/images/company/'.$item->logo)}}" alt=""></span>
                                  <div class="ms-5">
                                    <h4><a href="{{route('company-detail', $item)}}">{{$item->company_name}}</a></h4>
                                    <ul class="" style="padding: 0px">
                                        <li><span class="icon flaticon-briefcase"></span> {{$item->name}}</li>
                          ...
                          <td>
                            <div class="d-flex text-white">
                                <a href="{{route('cancelSaveCompany', $item->id)}}" class="ms-3 btn btn-secondary">Bỏ lưu</a>
                            </div>
